# Generated by Django 3.2 on 2021-10-12 02:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appname', models.CharField(blank=True, max_length=64, verbose_name='业务系统名称')),
                ('appdesc', models.CharField(blank=True, max_length=256, null=True, verbose_name='业务系统描述')),
            ],
        ),
        migrations.CreateModel(
            name='CloudAK',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instance_id', models.CharField(blank=True, max_length=32, null=True, verbose_name='实例id')),
                ('hostname', models.CharField(blank=True, max_length=64, verbose_name='主机名')),
                ...
                ('cloud_type', models.CharField(choices=[('aliyun', '阿里云'), ('server', '物理机'), ('tencent', '腾讯云'), ('virtual_machine', '虚拟机')], default='aliyun', max_length=32, verbose_name='类型')),
            ],
            options={
                'verbose_name': '服务器信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instance', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='disk', to='easyops.server', verbose_name='实例ID')),
            ],
            options={
                'verbose_name': '硬盘管理',
